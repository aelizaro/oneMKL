...
oneapi::mkl::vm::status set_status(cl::sycl::queue & queue, oneapi::mkl::vm::status new_status) {
    oneapi::mkl::vm::detail::status_result ret = oneapi::mkl::vm::detail::set_status(queue, new_status);
    return ret.second;
}
oneapi::mkl::vm::status clear_status(cl::sycl::queue & queue) {
    oneapi::mkl::vm::detail::status_result ret = oneapi::mkl::vm::detail::set_status(queue, vm::status::success);
    return ret.second;
}
