...
oneapi::mkl::vm::mode set_mode(oneapi::mkl::device libkey, cl::sycl::queue& queue,
...
oneapi::mkl::vm::status set_status(oneapi::mkl::device libkey, cl::sycl::queue& queue,
...
cl::sycl::event add(oneapi::mkl::device libkey, cl::sycl::queue& q, std::int64_t n,
...
cl::sycl::event add(oneapi::mkl::device libkey, cl::sycl::queue& q, std::int64_t n, float* a,
                    float* b, float* y, cl::sycl::vector_class<cl::sycl::event> const& depends,
...
cl::sycl::event add(oneapi::mkl::device libkey, cl::sycl::queue& q, std::int64_t n, double* a,
