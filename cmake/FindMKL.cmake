...
if(UNIX)
  ...
  set(MKL_SYCL_FULL_PATH ${MKL_LIB_DIR}/lib${MKL_SYCL}${LIB_SUFF})
else()
  if(${BUILD_SHARED_LIBS})
  ...
  set(MKL_SYCL_FULL_PATH ${MKL_LIB_DIR}/${MKL_SYCL}${LIB_SUFF})
endif()
...
if (ENABLE_MKLCPU_BACKEND OR ENABLE_MKLGPU_BACKEND)
  ...
  if(ENABLE_MKLGPU_BACKEND)
    set(MKL_LINK_SYCL ${MKL_SYCL_FULL_PATH} ${MKL_LINK_PREFIX} ${MKL_LINK_C} ${LIB_PREFIX}${OPENCL_LIBNAME} )
  endif()
endif()
